...
SECRET_KEY = 'django-insecure-0*xjk(y9iz5p025r+$g!iq$a^@#0$c5#=i+l#om=dxf)i&s=)q'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.BrokenLinkEmailsMiddleware',  # Optional for better error reporting
]
